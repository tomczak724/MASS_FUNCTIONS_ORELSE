...
fields = []
fields.append(field('N200',    'nep200_v0.0.5',       0.691,  0.027, alpha=1./600, chi2red_thresh=7, uvj_intercept=0.49))
...
fields.append(field('SC0849',  'sc0849+4452_v0.0.2',  1.261,  0.029, alpha=1./600, chi2red_thresh=10, uvj_intercept=0.54))
print ''
